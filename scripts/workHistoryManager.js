    ...
    if(workCards.length === 0){
        cardsContainer.innerHTML += `<div class="banner">
            ...
            <button class="button button-secondary" style="width: fit-content; align-self: center; margin-bottom: 1rem;"
                onclick="window.location.assign('http://127.0.0.1:5500/pages/add-work-history.html')"
        ...
        cardsContainer.innerHTML += `<div class="card-add" onclick="window.location.assign('http://127.0.0.1:5500/pages/add-work-history.html')">
            +
        </div>`;
